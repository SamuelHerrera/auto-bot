...
const configSchema = z.object({
  ...
  KITCHEN_API_BASE_URL: z.string().url().default("http://127.0.0.1:3001"),
  HERMES_KITCHENIA_API_KEY: z.string().default(""),
  HERMES_KITCHENIA_AUTH_HEADER: z.string().default("Authorization"),
  HERMES_KITCHENIA_AUTH_SCHEME: z.string().default("Bearer"),
