...
function buildApiProxy() {
  ...
  return {
    ...
    "/postback-actions": { target, changeOrigin: true },
    "/postback-action-runs": { target, changeOrigin: true },
    "/postback-maintenance": { target, changeOrigin: true },
    "/runtime": { target, changeOrigin: true },
